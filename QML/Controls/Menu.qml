...
Item {
    ...
    // API
    property var model: [] // Array of objects: { index, text, icon, trailingText, trailingIcon, type: "item"|"separator", enabled: bool, subItems: [] }
    ...
    // Signals
    signal closed()
    signal itemClicked(var itemData, var delegateIndex)
    ...
    Item {
        ...
        Item {
            ...
            DropShadow {
                ...
                horizontalOffset: 0
                verticalOffset: _elevation.level2
                radius: _elevation.level2 * 1.2   // аналог blur
                samples: 16

                color: Qt.rgba(_colors.shadow.r, _colors.shadow.g, _colors.shadow.b, 0.2)
            }
            ...
            Ripple {
                ...
                onClicked: {
                    if (hasSubMenu) {
                        ...
                        itemClicked(itemData, itemData.index)
